"""Static checks for Weather Bot source-fetching approval-request draft closeout."""
...
ARTIFACT_PATH = REPO_ROOT / "docs/prd/PRD-P1-WX-STAGE2-SOURCE-FETCHING-APPROVAL-REQUEST-DRAFT-CLOSEOUT-01.md"
CANONICAL_ID = "PRD-P1-WX-STAGE2-SOURCE-FETCHING-APPROVAL-REQUEST-DRAFT-CLOSEOUT-01"
MACHINE_HEADING = "## Machine-checkable source-fetching approval-request draft closeout assignments"
...
ALLOWED_ASSIGNMENTS = {
    ...
    "draft closeout status": {"draft_artifact_closed_out", "closeout_checkpoint_only", "docs_static_test_only"},
    "draft artifact posture": {"draft_packet_exists", "human_review_only", "non_authoritative"},
...
def test_closeout_static_human_review_and_non_approval_posture() -> None:
    text = _read_artifact()
    required_phrases = (
        "This is closeout/checkpoint only.",
        "This is docs/static-test-only.",
        "This closes out the draft artifact only",
        "The draft remains human-review-only.",
        "This is not a human approval decision.",
        "Approval was not granted.",
        "Implementation was not approved.",
        "This closeout does not grant approval",
...
def test_machine_checkable_parser_is_section_scoped() -> None:
    ...
    assert "- weather bot planning stage: source_fetching_approval_request_draft_closeout" in section
    synthetic_text = (
        f"{MACHINE_HEADING}\n"
        "- weather bot planning stage: source_fetching_approval_request_draft_closeout\n"
        "## Acceptance criteria\n"
    ...
    assert _assignments(synthetic_text) == {"weather bot planning stage": {"source_fetching_approval_request_draft_closeout"}}
