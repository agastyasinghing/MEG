"""Static checks for Weather Bot Phase 0A manual-review checklist planning."""
...
CANONICAL_ID = "WEATHER-BOT-PHASE0A-MANUAL-REVIEW-CHECKLIST-PLANNING-01"
ARTIFACT_PATH = REPO_ROOT / f"docs/prd/{CANONICAL_ID}.md"
TEST_PATH = REPO_ROOT / "tests/core/test_weather_bot_phase0a_manual_review_checklist_planning_01.py"
MACHINE_HEADING = "Machine-checkable Weather Bot Phase 0A manual-review checklist-planning assignments"
NEXT_TRACK = "weather_bot_phase0a_no_lookahead_policy_documentation"
CONDITIONAL_TRACK = "weather_bot_phase0a_manual_review_checklist_revision_if_scope_too_broad"

REQUIRED_SECTIONS = (
    "Status and scope", "Relationship to settlement-rule taxonomy planning",
    "Checklist objective", "Current held/closed source-fetching posture",
    "No owner-decision revision boundary", "Manual review checklist overview",
    "Settlement-rule review checklist", "Resolution-source review checklist",
    "Weather measurement review checklist", "Time-window review checklist",
    "Location review checklist", "Threshold and comparator review checklist",
    "Outcome mapping review checklist", "Canonical identifier review checklist",
    "Operator decision checklist", "Manual-review reason taxonomy",
...
MANUAL_REVIEW_CHECKLIST = {
    "check_resolution_source_present", "check_resolution_source_unambiguous",
    "check_settlement_rule_text_present", "check_question_text_consistent",
    "check_measurement_type_supported", "check_measurement_unit_unambiguous",
    "check_threshold_present", "check_comparator_unambiguous",
    "check_time_window_present", "check_time_window_unambiguous",
    "check_location_present", "check_location_unambiguous",
    "check_reporting_authority_present", "check_fallback_rule_present_if_needed",
    "check_outcome_labels_match_tokens", "check_token_outcome_pair_preserved",
    "check_condition_token_outcome_preserved", "check_operator_review_required_flag",
}
MANUAL_REVIEW_REASONS = {
    "missing_resolution_source", "ambiguous_resolution_source", "missing_settlement_rule_text",
    "question_rule_conflict", "ambiguous_location", "ambiguous_time_window",
    "ambiguous_measurement_unit", "ambiguous_threshold", "ambiguous_comparator",
    "conflicting_source_text", "unsupported_weather_measurement", "outcome_token_mismatch",
    "operator_review_required",
}
OPERATOR_DECISIONS = {
    "manual_review_pass", "manual_review_blocked_missing_required_field",
    "manual_review_blocked_ambiguous_rule", "manual_review_blocked_identifier_mismatch",
    "manual_review_blocked_unsupported_measurement", "manual_review_requires_followup_planning",
}
BLOCKED_WORK = {
    ...
    "settlement_rule_runtime_classification", "manual_review_runtime_workflow",
    "manual_review_ui", "manual_review_persistence", "operator_decision_execution",
    "scoring_implementation", "backtesting_implementation", "runtime_trading_behavior",
    "order_placement", "autonomy_behavior", "production_behavior", "audit_report_generation",
...
ALLOWED_ASSIGNMENTS = {
    ...
    "manual review checklist status": {"docs_static_test_only", "manual_review_checklist_planning_only", "post_weather_bot_phase0a_settlement_rule_taxonomy_planning"},
    ...
    "manual review checklist item": MANUAL_REVIEW_CHECKLIST,
    "manual review reason": MANUAL_REVIEW_REASONS,
    "operator decision label": OPERATOR_DECISIONS,
    ...
    "implementation posture": {"docs_static_test_only", "manual_review_checklist_planning_only", "no_runtime_code_change", "no_owner_decision_revision", "no_source_fetching", "no_source_fetching_plan", "no_provider_connector", "no_provider_client", "no_live_provider_fetching", "no_credential_config_loading", "no_generated_data", "no_fixture_change", "no_settlement_rule_runtime_parser", "no_manual_review_runtime_workflow", "no_scoring_backtesting", "no_trading_autonomy_production", "no_report_writing", "no_external_export", "no_persistence"},
...
FORBIDDEN_APPROVAL_RE = re.compile(
    ...
    r"operator decision execution " "is approved|scoring " "is approved|backtesting " "is approved|"
...
def test_document_exists_canonical_id_and_sections_are_non_empty() -> None:
    ...
    text = _read()
    assert text.startswith(f"# {CANONICAL_ID} — Weather Bot Phase 0A Manual Review Checklist Planning")
...
def test_required_posture_and_non_execution_boundaries_are_present() -> None:
    text = _read()
    required = [
        "docs/static-test-only/manual-review-checklist-planning-only",
...
def test_checklist_values_reasons_decisions_blocked_work_and_stage2_paths_appear() -> None:
    text = _read()
    for value in MANUAL_REVIEW_CHECKLIST | MANUAL_REVIEW_REASONS | OPERATOR_DECISIONS | BLOCKED_WORK | STAGE2_PATHS:
...
def test_machine_assignments_are_section_scoped_complete_and_allowed() -> None:
    ...
    assert by_field["conditional next track"] == {"weather_bot_phase0a_manual_review_checklist_revision_if_scope_too_broad"}
