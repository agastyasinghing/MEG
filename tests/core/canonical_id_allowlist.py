...
_ARCH_ALIGN_03_DOWNSTREAM_ARTIFACTS = {
    ...
    "tests/core/test_weather_bot_stage3_historical_corpus_construction_and_acquisition_approval_decision_01.py",
    ...
    "tests/core/test_weather_bot_stage3_scoring_and_diagnostics_implementation_approval_request_01.py",
    ...
    "docs/prd/WEATHER-BOT-STAGE3-SCORING-AND-DIAGNOSTICS-CONTRACT-PLANNING-01.md",
    ...
    "docs/prd/WEATHER-BOT-STAGE3-EVIDENCE-GATE-DECISION-RECORD-CONTRACT-PLANNING-01.md",
    ...
    "docs/prd/WEATHER-BOT-STAGE3-BASELINE-CONTRACTS-IMPLEMENTATION-APPROVAL-REQUEST-01.md",
    "tests/core/test_weather_bot_stage3_baseline_contracts_implementation_approval_request_01.py",
    "docs/prd/WEATHER-BOT-STAGE3-EVIDENCE-EXECUTION-READINESS-REVIEW-01.md",
    "tests/core/test_weather_bot_stage3_evidence_execution_readiness_review_01.py",
}
...
ALLOWED_MARKET_ID_OCCURRENCE_LINES: dict[str, int] = _MarketIdAllowlist({
    ...
    # Stage 3 scoring diagnostics planning uses market_id only as a non-routing negative boundary.
    "docs/prd/WEATHER-BOT-STAGE3-SCORING-AND-DIAGNOSTICS-CONTRACT-PLANNING-01.md": 3,
    "tests/core/test_weather_bot_stage3_scoring_and_diagnostics_contract_planning_01.py": 5,
    ...
    # Stage 3 evidence-gate decision-record planning uses market_id only as a non-routing negative boundary.
    "docs/prd/WEATHER-BOT-STAGE3-EVIDENCE-GATE-DECISION-RECORD-CONTRACT-PLANNING-01.md": 3,
    "tests/core/test_weather_bot_stage3_evidence_gate_decision_record_contract_planning_01.py": 6,
    # Stage 3 implementation readiness review uses market_id only as a non-routing negative boundary.
    ...
    "tests/core/test_weather_bot_stage3_strict_oos_split_implementation_approval_request_01.py": 2,
    # Stage 3 baseline contracts implementation approval request uses market_id only as a non-routing negative boundary.
    "docs/prd/WEATHER-BOT-STAGE3-BASELINE-CONTRACTS-IMPLEMENTATION-APPROVAL-REQUEST-01.md": 1,
    "tests/core/test_weather_bot_stage3_baseline_contracts_implementation_approval_request_01.py": 3,
    # Stage 3 scoring diagnostics approval request uses market_id only as a non-routing negative boundary.
    "docs/prd/WEATHER-BOT-STAGE3-SCORING-AND-DIAGNOSTICS-IMPLEMENTATION-APPROVAL-REQUEST-01.md": 1,
    "tests/core/test_weather_bot_stage3_scoring_and_diagnostics_implementation_approval_request_01.py": 2,
    # Stage 3 evaluation-result approval request uses market_id only as a non-routing negative boundary.
    ...
    # Stage 3 corpus-acquisition approval decision uses market_id only as a non-routing negative boundary.
    "docs/prd/WEATHER-BOT-STAGE3-HISTORICAL-CORPUS-CONSTRUCTION-AND-ACQUISITION-APPROVAL-DECISION-01.md": 2,
    "tests/core/test_weather_bot_stage3_historical_corpus_construction_and_acquisition_approval_decision_01.py": 2,
