...
DOC = ROOT / "docs/prd/PRD-P1-WX-UNBLOCK_EXPLICIT_PHASE_1_WEATHER_BOT_UNBLOCK_NOTE.md"
TEST_FILE = ROOT / "tests/core/test_prd_p1_wx_unblock_note.py"
...
def test_unblock_doc_exists() -> None:
    assert DOC.exists()


def test_unblock_doc_required_content() -> None:
    text = _text(DOC)
    required = [
        "explicit Phase 1 weather bot unblock note",
        ...
        "What this unblock approves",
        "What this unblock does not approve",
        "Kickoff requirements",
        "Risk controls entering Phase 1",
        "PRD-P1-WX-KICKOFF",
    ]
