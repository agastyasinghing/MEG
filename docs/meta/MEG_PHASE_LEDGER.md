...
- No fixture data, ingestion, provider/API connector, scoring/backtesting, runtime, trading, order placement, autonomy, or production behavior is approved by this ledger.
