...
- Canonical routing fields remain exactly `condition_id`, `token_id`, and `outcome`; the legacy market identifier remains non-routing only; `token_outcome_pair` remains derived only.
